...
public class EndView extends BaseView {
    ...
    public void drawSelf() {
        try {
            ...
            float textlong = paint.measureText("Overscore:" + String.valueOf(score));
            canvas.drawText("Overscore:" + String.valueOf(score), screen_width / 2 - textlong / 2, screen_height / 2 - 100, paint);
        } catch (Exception err) {
            err.printStackTrace();
        } finally {
            if (canvas != null)
